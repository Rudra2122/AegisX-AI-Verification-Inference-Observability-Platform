...
; yosys-smt2-witness {"offset": 0, "path": ["\\dut", "\\q"], "smtname": 5, "smtoffset": 0, "type": "init", "width": 4}
(declare-fun |counter_tb#5| (|counter_tb_s|) (_ BitVec 4)) ; \dut.q
; yosys-smt2-register dut.q 4
...
(define-fun |counter_tb_t| ((state |counter_tb_s|) (next_state |counter_tb_s|)) Bool (and
  (= (|counter_tb#5| state) (|counter_tb#5| next_state)) ; $auto$clk2fflogic.cc:108:sample_data$40 \dut.q
